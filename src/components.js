            ...
            <div className="row" id="description">
              <div className="col-12">
                <h4> 
                    ...
                    and a width of 4 pixels. The colors have been programmatically generated by taking combinations of 
                    red, green and blue colors. Each color ranges over 32 values from 7 to 255 in steps of 8.
                </h4>
              </div>
            </div>
